...
//     id: suggestion.id,
//     parts: modifyString(input, suggestion.name), //returns an array with 3 indexes: 1-everything in the 'name' string BEFORE the input. 
//     // 2 -the input
//     // 3 -everything in the 'name' string AFTER the input.
//     }))
//   return suggestions2;
// }
